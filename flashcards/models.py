...
class Card_Set(models.Model):
    ...
    is_active = models.BooleanField(
        default=True
    )  # When Card_Set is created, it will default to
    ...
    get_card_count.short_description = (
        "Card Count"  # Card Count is the column header in Admin Panel
    )
...
class Card(models.Model):
    ...
    question = models.CharField(max_length=150, null=False, blank=False)  # Question
